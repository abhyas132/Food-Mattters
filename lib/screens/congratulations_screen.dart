...
class _MyAppState extends ConsumerState<NewMyApp> {
  ...
  void initState() {
    ...
    _controllerBottomCenter =
        ConfettiController(duration: const Duration(seconds: 10));
    _controllerCenter.play(); //center
    _controllerCenterRight.play(); //center right
    _controllerCenterLeft.play(); //center left
    _controllerBottomCenter.play(); //bottom center
  }
  ...
  Widget build(BuildContext context) {
    final points = ref.watch(userDataProvider).points;
    return Scaffold(
        body: Stack(
      children: <Widget>[
        //CENTER -- Blast
